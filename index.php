...
<div class="container">
    ...
    <form class="marginBottom" action="index.php" method="post">
        ...
        <div class="marginBottom">
            ...
            <label for="graph"> Zobraziť graf</label><br>
            <input type="checkbox" id="anim" name="anim" value="Animation">
            <label for="anim"> Zobraziť animáciu</label><br>
        </div>

        <button type="submit" class="marginBottom">Submit</button>
